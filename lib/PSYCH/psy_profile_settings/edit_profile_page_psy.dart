...
class EditProfilePagePsy extends StatefulWidget {
  @override
  _EditProfilePagePsyState createState() => _EditProfilePagePsyState();
}

class _EditProfilePagePsyState extends State<EditProfilePagePsy> {
  ...
  applyChanges() async {
    FirebaseUser user = await _auth.currentUser();
    print('test123');
    Firestore.instance.collection('psikologlar').document(user.uid).updateData({
            ...
            children: <Widget>[
              ...
              SizedBox(
                child: IconButton(
                    ...
                    onPressed: () async {
                      applyChanges();
                      imagepath = await db.uploadImagePsy(_imageFile);
