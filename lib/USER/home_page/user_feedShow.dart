...
class FeedUser extends StatefulWidget {
  _FeedUser createState() => _FeedUser();
}

class _FeedUser extends State<FeedUser>
    with AutomaticKeepAliveClientMixin<FeedUser> {
  ...
  Future<List<Map<dynamic, dynamic>>> getFollowings() async {
    List<DocumentSnapshot> templist;
    List<Map<dynamic, dynamic>> list_following = new List.empty(growable: true);
    DocumentReference documentRef =
        Firestore.instance.collection("users").document(userID);
    QuerySnapshot collectionSnapshot =
        await documentRef.collection("following").getDocuments();

    templist = collectionSnapshot.documents; // <--- ERROR

    list_following = templist.map((DocumentSnapshot docSnapshot) {
  ...
  void getProfileData() async {
    try {
      ...
      QuerySnapshot followings = await Firestore.instance
          .collection("users")
          .document(userID)
...
/*
    return StreamBuilder(
      stream:Firestore.instance
            ...
            .document(po).collection(collectionPath)
            .snapshots() ,
      builder: ,);*/
  }
...
class BegendimSayfaUser extends StatefulWidget {
  BegendimSayfaUser();

  @override
  _BegendimSayfaUserState createState() => new _BegendimSayfaUserState();
}

class _BegendimSayfaUserState extends State<BegendimSayfaUser> {
  @override
  Widget build(BuildContext context) {
    return Center(
      child: Column(
